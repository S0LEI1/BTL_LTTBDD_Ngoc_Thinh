...
export default function DangNhap({navigation}) {
  return (
    ...
    <View style={{width:'100%',height:'150px',justifyContent:'center',alignItems:'center',marginLeft:'20px',padding:10}}>
    ...
    <Pressable style={{}} onPress={() => {navigation.navigate('DangNhapTK')}}>
